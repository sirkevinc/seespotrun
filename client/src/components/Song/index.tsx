...
export default function Song({ order, track }: IProps) {
    ...
    return (
        <div className="grid grid-cols-2 text py-4 px-5 rounded-lg cursor-pointer" onClick={playSong}>
            ...
            <div className="flex items-center justify-between md:ml-0">
